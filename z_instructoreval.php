 ...
 if(isset($_POST['Submit'])){
      ...
      popup("Your comments for " . $rfour[lname] . ", " . $rfour[fname] . " have been submitted.");
            ...
            mysql_select_db("drallen1");
						...
						$qsix = mysql_query($sql = "SELECT * FROM users u WHERE u.GROUP_ID=" . $session->GROUP_ID . " AND EXISTS(SELECT * FROM Eval e WHERE u.STUDENT_ID=e.STUDENT_ID) AND u.STUDENT_ID != " . $session->STUDENT_ID);
				...
				$(document).ready(function(){
							...
							$('#graded').change(
								function() {
									...
									$.get( "z_displayeval.php?graderid=" + graderid + "&studentid=" + studentid,
										function(data){
