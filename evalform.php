<?php include("includes/header.php");
  if ($session->userlevel > 8 || $session->userlevel < 8){
    ...
    //if(numE>=1){
      ...
      }/*elseif(isset($_POST['Submit']) && $_POST[graded]==NULL){
        $check=1;
      }*/
      echo "<!DOCTYPE html>
        <html lang=\"en\">
              ...
              <?/*********************************************************
                ...
                *********************************************************/
                ...
                for($i=0;$i<$numB;$i++){ 
                  ...
                  if($check != 1){
                    echo "<font size=\"2\"color=\"red\">***Please fill out the entire evaluation***</font>";
                    ...
                    Comments: <textarea name="<?php echo $rtwo['BEHAVIOR_ID'];?>" rows="5" cols="50"><?php echo $_POST[graded];?></textarea> </br><?php
